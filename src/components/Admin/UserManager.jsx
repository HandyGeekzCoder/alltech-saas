...
const UserManager = () => {
    const { users, addClientAccount, updateSiteDetails } = useContext(AdminContext);
                                        ...
                                        <div style={{ padding: '0 16px 16px 16px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                                            ...
                                            {subEmployees.length > 0 && (
                                                <div style={{ marginTop: '24px' }}>
                                                    <h4 style={{ color: 'var(--text-muted)', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '12px', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '4px' }}>Linked Sub-Employees</h4>
